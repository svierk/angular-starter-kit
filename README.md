...
[![Validation](https://github.com/svierk/angular-starter-kit/actions/workflows/ci.yml/badge.svg?branch=main&event=push)](https://github.com/svierk/angular-starter-kit/actions/workflows/ci.yml)
